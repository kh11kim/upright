...
from upright.utils import workspace_lines
from upright.utils.body import Body
from upright.utils.camera import Camera, CameraIntrinsic
from upright.utils.transform import Rotation, Transform
from upright.utils.robot import Robot, Panda
...
class BulletWorld:
    ...
    def add_camera(self, intrinsic: CameraIntrinsic, near: float, far: float) -> Camera:
...
if __name__ == "__main__":
    ...
    box_pose = Transform(Rotation.identity(), [0.3, 0, 0.1])
